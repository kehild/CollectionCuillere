...
<section>
	<div class="transbox">
		<form id="saisieForm" method="post" action="">
			...
			<?php $myfile = fopen("texte/info1.txt", "r+") or die("Unable to open file!"); // Ouverture du fichier
			echo utf8_encode(fread($myfile,filesize("texte/info1.txt"))); // lecture du contenu du fichier
...
<?php
	if(isset($_POST['save'])){
		$myfile = fopen("texte/info1.txt", "r+") or die("Unable to open file!"); // Ouverture du fichier
